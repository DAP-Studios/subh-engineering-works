      ...
      <header className="relative min-h-[350px] bg-gray-900 text-white flex items-center overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 py-20 w-full">
          ...
          <p className="text-lg text-gray-300 max-w-2xl">
            Established in 2015, we deliver dependable industrial valve
            manufacturing, sales, and servicing solutions across India.
          </p>
        </div>
      </header>
      ...
      <section className="py-24 px-6 border-b border-gray-200">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-700 mb-6 leading-relaxed max-w-5xl">
            Subh Engineering Works is a dedicated industrial valve company
            established in 2015, offering a comprehensive range of valve
            manufacturing, sales, and servicing solutions. Over the years, we
            have built a strong reputation for reliability, quality, and
            technical expertise across multiple industries throughout India.
          </p>
          <p className="text-gray-700 leading-relaxed max-w-5xl">
            We believe in building long-term relationships with our clients by
            delivering consistent quality, honest pricing, and responsive
            after-sales support. Whether you need a single valve or a bulk
            industrial order, we treat every project with the same level of care
            and commitment.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="bg-white border-2 border-gray-200 p-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              To deliver high-performance industrial valve solutions that
              empower industries to operate safely, efficiently, and without
              interruption - backed by world-class manufacturing and dedicated
              service.
            </p>
          </div>
          <div className="bg-white border-2 border-gray-200 p-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              To become a leading name in industrial valve solutions across
              India, recognized for innovation, quality, and an uncompromising
      ...
      <section className="py-24 px-6 border-b border-gray-200">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-2 border-gray-200 p-8 bg-gray-50">
            ...
            <p className="text-sm uppercase tracking-widest font-bold text-gray-600 mb-6">
              Founder and Managing Director | Subh Engineering Works
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              With a deep-rooted passion for engineering and industrial systems,
              Hitech Bhai founded Subh Engineering Works in 2015 with a clear
              vision - to provide industries with dependable,
              precision-engineered valve solutions at competitive prices.
            </p>
            <p className="text-gray-700 leading-relaxed">
              With years of hands-on experience in the valve manufacturing and
              servicing sector, he leads the company with a customer-first
              philosophy, ensuring every client receives not just a product, but
              a complete engineering solution. Under his leadership, Subh
              Engineering Works has grown into a trusted name in the industrial
              valve space, serving clients across diverse sectors throughout
              India.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={idx}
                className="border-l-4 pl-6 py-3 bg-white"
                style={{ borderLeftColor: "#D22B2B" }}
              >
      ...
      <section className="bg-black text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-10 text-gray-300">
            Partner with Subh Engineering Works for reliable valve solutions,
            honest support, and long-term value.
          </p>
          <button
