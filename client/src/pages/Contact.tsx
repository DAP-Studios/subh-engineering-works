      ...
      <header className="relative min-h-[350px] bg-gray-900 text-white flex items-center overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 py-20 w-full">
          ...
          <p className="text-lg text-gray-300 max-w-3xl">
            Have a requirement, a question, or need a quote? Our team is ready to assist you with product and service support.
          </p>
        </div>
      </header>
      ...
      <section className="bg-gray-50 py-10 px-6 border-b border-gray-200">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-4">
          <div className="bg-white border border-gray-200 p-4">
            <p className="text-xs uppercase font-bold tracking-widest text-gray-600 mb-1">Fast Response</p>
            <p className="font-semibold text-gray-800">Within 24 business hours</p>
          </div>
          <div className="bg-white border border-gray-200 p-4">
            <p className="text-xs uppercase font-bold tracking-widest text-gray-600 mb-1">Support Scope</p>
            <p className="font-semibold text-gray-800">Sales, Service, Manufacturing</p>
          </div>
          <div className="bg-white border border-gray-200 p-4">
            <p className="text-xs uppercase font-bold tracking-widest text-gray-600 mb-1">Coverage</p>
            <p className="font-semibold text-gray-800">Pan-India industrial support</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 border-b border-gray-200">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50 p-8 border-2 border-gray-200">
            ...
            <p className="text-gray-600 mb-8">Share your requirement details and our team will connect with a practical recommendation.</p>
